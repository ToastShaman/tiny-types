...
import static com.github.toastshaman.tinytypes.aws.sqs.PollingSqsEvents.*;
...
public sealed interface PollingSqsEvents extends Event permits PollingFailed, PollingSuccess {
